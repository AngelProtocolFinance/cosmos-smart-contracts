...
export async function startSetupCore(): Promise<void> {
  ...
  await setupCore(
    ...
    // config
    {
      ...
      charity_cw3_multisig_threshold_abs_perc: "0.5", // threshold absolute percentage for "charity-cw3"
      charity_cw3_multisig_max_voting_period: 100000,      // max_voting_period time(unit: seconds) for "charity-cw3"
