...
import { sendMessageViaCw3Proposal, sendMessagesViaCw3Proposal, sendTransaction, storeCode, migrateContract, storeAndMigrateContract, toEncodedBinary } from "../../utils/helpers";
...
export async function migrateCore(
  ...
  await migrateEndowmentCw3s(juno, apTeam, cw3ApTeam, registrar, accounts, 16);
}
