...
use angelprotocol_lbp::asset::{Asset, AssetInfo, PairInfo, WeightedAsset};
use angelprotocol_lbp::pair::{
    Cw20HookMsg, ExecuteMsg, InstantiateMsg, MigrateMsg, PoolResponse, QueryMsg,
    ReverseSimulationResponse, SimulationResponse,
};
use angelprotocol_lbp::querier::query_supply;
use angelprotocol_lbp::token::InstantiateMsg as TokenInstantiateMsg;
use std::ops::{Add, Div, Mul, Sub};
use std::str::FromStr;

// version info for migration info
const CONTRACT_NAME: &str = "angelprotocol-lbp-pair";
    ...
    Ok(Response::new().add_submessage(SubMsg {
        ...
        msg: WasmMsg::Instantiate {
            ...
            msg: to_binary(&TokenInstantiateMsg {
                name: "angelprotocol-lbp liquidity token".to_string(),
            ...
            funds: vec![],
            admin: None,
            label: String::from("angelprotocol-lbp liquidity token"),
        }
        .into(),
        gas_limit: None,
...
/// we compute new spread else we just use angelprotocol-lbp
