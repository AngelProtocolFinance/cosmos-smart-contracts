...
use halo_lbp::factory::{ConfigResponse, ExecuteMsg, InstantiateMsg, QueryMsg};
...
fn store_factory_code(app: &mut App) -> u64 {
    let pair_contract = Box::new(
        ContractWrapper::new(
            lbp_factory::contract::execute,
            lbp_factory::contract::instantiate,
            lbp_factory::contract::query,
        )
        .with_reply(lbp_factory::contract::reply),
    );
...
fn store_pair_code(app: &mut App) -> u64 {
    let pair_contract = Box::new(
        ContractWrapper::new(
            lbp_pair::contract::execute,
            lbp_pair::contract::instantiate,
            lbp_pair::contract::query,
        )
        .with_reply(lbp_pair::contract::reply),
    );
...
fn store_token_code(app: &mut App) -> u64 {
    let terra_swap_token_contract = Box::new(ContractWrapper::new(
        lbp_token::contract::execute,
        lbp_token::contract::instantiate,
        lbp_token::contract::query,
    ));
