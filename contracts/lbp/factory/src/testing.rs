...
use angelprotocol_lbp::factory::{ConfigResponse, ExecuteMsg, InstantiateMsg, PairsResponse, QueryMsg};
    ...
    assert_eq!(
        ...
        vec![SubMsg::reply_on_success(
            CosmosMsg::Wasm(WasmMsg::Instantiate {
                ...
                label: String::from("AngelProtocol pair"),
            }),
            0
        )]
    );
...
fn register() {
    ...
    let pair0_info = PairInfo {
        ...
        factory_addr: Addr::unchecked("factory000"),
        start_time,
        end_time,
        description: Some(String::from("description")),
        commission_rate: COMMISSION_RATE.to_string(),
    ...
    // register angelprotocol-lbp pair querier
    deps.querier.with_angelprotocol_lbp_pairs(&deployed_pairs);
