...
use angelprotocol_lbp::pair::ExecuteMsg as PairExecuteMsg;
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        lbp_factory: Addr::unchecked("angelprotocollbpfactory"),
    };
    ...
    assert_eq!("angelprotocollbpfactory", config.lbp_factory.as_str());
}
    ...
    assert_eq!(
        ...
        vec![
            ...
            SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
                ...
                funds: vec![],
                msg: to_binary(&ExecuteMsg::ExecuteSwapOperation {
                    operation: SwapOperation::AngelSwap {
                        offer_asset_info: AssetInfo::NativeToken {
                            denom: "ukrw".to_string(),
                        },
                        ask_asset_info: AssetInfo::Token {
...
fn execute_swap_operation() {
    ...
    deps.querier.with_angelprotocol_lbp_pairs(&[(
        &"assetuusd".to_string(),
        &FactoryPairInfo {
