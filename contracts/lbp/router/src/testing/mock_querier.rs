...
use angelprotocol_lbp::pair::SimulationResponse;
...
pub struct WasmMockQuerier {
    ...
    lbp_factory_querier: FactoryQuerier,
}
    ...
    fn handle_default(&self, msg: &Binary) -> QuerierResult {
        match from_binary(&msg).unwrap() {
            QueryMsg::Pair { asset_infos } => {
                ...
                match self.lbp_factory_querier.pairs.get(&key) {
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier<TerraQueryWrapper>) -> Self {
        WasmMockQuerier {
            ...
            lbp_factory_querier: FactoryQuerier::default(),
        }
    }
    ...
    pub fn with_angelprotocol_lbp_pairs(&mut self, pairs: &[(&String, &FactoryPairInfo)]) {
        self.lbp_factory_querier = FactoryQuerier::new(pairs);
    }
}
