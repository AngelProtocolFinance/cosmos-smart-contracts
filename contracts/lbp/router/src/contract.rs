...
use angelprotocol_lbp::asset::{Asset, AssetInfo};
use angelprotocol_lbp::factory::FactoryPairInfo;
use angelprotocol_lbp::pair::{QueryMsg as PairQueryMsg, SimulationResponse};
use angelprotocol_lbp::querier::query_factory_pair_info;
use angelprotocol_lbp::router::{
...
const CONTRACT_NAME: &str = "angelprotocol-lbp-router";
...
fn simulate_swap_operations(
    ...
    let lbp_factory = config.lbp_factory;
