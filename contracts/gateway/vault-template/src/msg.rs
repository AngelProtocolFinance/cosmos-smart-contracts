...
pub struct InstantiateMsg {
    // Address of Account Ledgers SC
    pub account_ledgers_sc: String,

    // Vault Basic information
    ...
    // Derivative Token Information
    pub token_name: String, // name of the derivative token
    pub token_symbol: String, // symbol / ticker of the derivative token
    pub token_decimals: u8, // decimal places of the derivative token (for UI)
