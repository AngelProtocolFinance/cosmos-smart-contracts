...
This is mainly used from HaloSwap factory contract to create new HaloSwap pair. It initialize all swap created parameters which can be updated later with owner key.
