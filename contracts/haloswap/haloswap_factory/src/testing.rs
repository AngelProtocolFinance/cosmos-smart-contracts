...
use haloswap::factory::{ConfigResponse, ExecuteMsg, InstantiateMsg, QueryMsg};
use haloswap::pair::InstantiateMsg as PairInstantiateMsg;
...
fn reply_test() {
    ...
    // register HaloSwap pair querier
