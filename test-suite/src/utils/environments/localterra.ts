...
import { setupAstroportPlatform } from "../../setup/astroport/localterra";
import { setupAstroportVaults } from "../../setup/vaults/astroport";
import { testExecuteAstroport } from "../../tests/localterra";
...
async function initialize() {
  ...
  apTeam = new Wallet(
    terra,
    new MnemonicKey({ mnemonic: localterra.mnemonicKeys.test1 })
  );
  apTeam2 = new Wallet(
    terra,
    new MnemonicKey({ mnemonic: localterra.mnemonicKeys.test2 })
  );
  apTeam3 = new Wallet(
    terra,
    new MnemonicKey({ mnemonic: localterra.mnemonicKeys.test3 })
  );
  apTreasury = new Wallet(
    terra,
    new MnemonicKey({ mnemonic: localterra.mnemonicKeys.test4 })
  );
  ...
  console.log(
    `Using ${chalk.cyan(apTreasury.key.accAddress)} as Angel Protocol Treasury`
  );
  ...
  console.log(
    `Using ${chalk.cyan(astroportTokenCode)} as Astroport (cw20) Token Code`
  );
  console.log(`Using ${chalk.cyan(astroportPairCode)} as Astroport Pair Code`);
  console.log(
    `Using ${chalk.cyan(astroportFactory)} as Astroport Factory contract`
  );
  console.log(
    `Using ${chalk.cyan(astroportGenerator)} as Astroport Generator contract`
  );
  console.log(
    `Using ${chalk.cyan(astroportRouter)} as Astroport Router contract`
  );
  console.log(
    `Using ${chalk.cyan(astroTokenContract)} as Astroport ASTRO Token`
  );
  console.log(
  ...
  console.log(
    `Using ${chalk.cyan(
      usdcUsdtPairLpToken
    )} as Astroport USDC/USDT Swap Pair LP Token`
  );
  console.log(
    `Using ${chalk.cyan(
      usdcUsdtPairUsdcLiquidity
    )} as Astroport USDC/USDT Pair USDC liquidity`
  );
  console.log(
    `Using ${chalk.cyan(
      usdcUsdtPairUsdtLiquidity
    )} as Astroport USDC/USDT Pair USDT liquidity`
  );
  ...
  console.log(
    `Using ${chalk.cyan(
      lunaAstroPairLpToken
    )} as Astroport Luna/ASTRO Swap Pair LP Token`
  );
  console.log(
  ...
  console.log(
    `Using ${chalk.cyan(
      lunaUsdcPairLpToken
    )} as Astroport Luna/USDC Swap Pair LP Token`
  );
  console.log(
  ...
  console.log(
    `Using ${chalk.cyan(
      lunaUsdtPairLpToken
    )} as Astroport Luna/USDT Swap Pair LP Token`
  );
  console.log(
  ...
  console.log(
    `Using ${chalk.cyan(
      astroUsdcPairLpToken
    )} as Astroport ASTRO/USDC Swap Pair LP Token`
  );
}
