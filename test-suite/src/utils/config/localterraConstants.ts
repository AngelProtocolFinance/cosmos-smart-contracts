...
export const localterra = {
  ...
  // Astroport contracts
  astroport: {
    astroport_token_code: 11,
    astroport_pair_code: 12,

    ASTRO_token_contract: "",
    initial_ASTRO_supply: "1000000000000000",

    astroport_factory: "",
    astroport_generator: "",
    astroport_router: "",

    usdc_usdt_pair_contract: "",
    usdc_usdt_pair_lp_token: "",
    usdc_usdt_pair_usdc_liquidity: "100000000000",
    usdc_usdt_pair_usdt_liquidity: "100000000000",

    luna_astro_pair_contract: "",
    luna_astro_pair_lp_token: "",

    luna_usdc_pair_contract: "",
    luna_usdc_pair_lp_token: "",

    luna_usdt_pair_contract: "",
    luna_usdt_pair_lp_token: "",

    astro_usdc_pair_contract: "",
    astro_usdc_pair_lp_token: "",
  },
};
