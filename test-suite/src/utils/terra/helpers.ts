 ...
 */
export async function storeCode(terra: LocalTerra | LCDClient, deployer: Wallet, filepath: string): Promise<number> {
...
export async function migrateContracts(
    ...
    contracts.forEach((contract) => {
        msgs.push(new MsgMigrateContract(admin.key.accAddress, contract, new_code_id, migrateMsg));
