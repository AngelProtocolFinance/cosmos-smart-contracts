...
async function setup(
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")}=${registrarCodeId}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")}=${accountsCodeId}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")}=${cw3MultiSigApTeam}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")}=${cw3MultiSigEndowment}`
  );

  process.stdout.write("Uploading Endowment SubDAO Wasm");
  const subdao = await storeCode(
    juno,
    apTeamAddr,
    `${wasm_path.core}/subdao.wasm`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")}=${subdaoDonationMatch}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${registrar}`
  );

  // Index Fund
  process.stdout.write("Instantiating Index Fund contract");
  const fundResult = await instantiateContract(
    juno,
    apTeamAddr,
    apTeamAddr,
    fundCodeId,
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${indexFund}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${cw4GrpApTeam}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${cw3ApTeam}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${accounts}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${cw3ReviewTeam}`
  );
