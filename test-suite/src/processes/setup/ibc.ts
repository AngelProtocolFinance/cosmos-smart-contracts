...
async function postProcess() {
    ...
    await tSendTransaction(terra, terraIbcSetupper, [
        new MsgExecuteContract(terraIbcSetupper.key.accAddress, terraIcaController1, {
            update_admin: {
    ...
    await tSendTransaction(terra, terraIbcSetupper, [
        new MsgExecuteContract(terraIbcSetupper.key.accAddress, terraIcaController2, {
            update_admin: {
    ...
    console.log(
        chalk.green(" Done!"),
        `${chalk.blue("Terra Vault1(Locked) - contractAddress")}=${accountInfo1.account}`
    );
    ...
    console.log(
        chalk.green(" Done!"),
        `${chalk.blue("Terra Vault1(Liquid) - contractAddress")}=${accountInfo2.account}`
    );
}
...
async function customConnSetup(srcConfig: ChainDefinition, destConfig: ChainDefinition, logger?: Logger) {
    ...
    console.log(
        chalk.green(" Done!"),
        `${chalk.blue("JUNO cont -> TERRA host channelId")}=${channel0.src.channelId}, ${channel0.dest.channelId}`
    );
    console.log(
        chalk.green(" Done!"),
        `${chalk.blue("TERRA cont1 -> JUNO host channelId")}=${channel1.src.channelId}, ${channel1.dest.channelId}`
    );
    console.log(
        chalk.green(" Done!"),
        `${chalk.blue("TERRA cont2 -> JUNO host channelId")}=${channel2.src.channelId}, ${channel2.dest.channelId}`
    );
