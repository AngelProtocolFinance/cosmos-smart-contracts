...
// Querying tests
//----------------------------------------------------------------------------------------
export async function testQueryAirdropConfig(juno: SigningCosmWasmClient, airdropContract: string): Promise<void> {
...
export async function testQueryAirdropLatestStage(juno: SigningCosmWasmClient, airdropContract: string): Promise<void> {
