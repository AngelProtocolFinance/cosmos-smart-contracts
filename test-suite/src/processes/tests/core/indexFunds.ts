...
export async function testIndexFundUpdateOwner(
    ...
    process.stdout.write("Test - Owner can set new_owner address in an Index Fund");
...
export async function testIndexFundUpateRegistrar(
    ...
    process.stdout.write("Test - Owner can set new_registrar address in an Index Fund");
...
export async function testDonorSendsToIndexFund(
    ...
    process.stdout.write("Test - Donor (normal pleb) can send a JUNO donation to an Index Fund fund");
...
export async function testQueryIndexFundConfig(juno: SigningCosmWasmClient, indexFund: string): Promise<void> {
...
export async function testQueryIndexFundState(juno: SigningCosmWasmClient, indexFund: string): Promise<void> {
...
export async function testQueryIndexFundTcaList(juno: SigningCosmWasmClient, indexFund: string): Promise<void> {
...
export async function testQueryIndexFundDeposit(juno: SigningCosmWasmClient, indexFund: string): Promise<void> {
...
export async function testQueryIndexFundInvolvedAddress(
    ...
    process.stdout.write("Test - Query IndexFund for all funds an Address is involoved with");
    const result: any = await juno.queryContractSmart(indexFund, {
