...
export async function testCronstringCanDirectlyHarvestVault(
    ...
    process.stdout.write("Test - Cron wallet triggers harvest of single Vault (Locked to Liquid Account)");
    await expect(
...
export async function testUpdateFees(
    ...
    process.stdout.write("Test - Owner can update EndowTypeFees in Registrar");
...
export async function testQueryRegistrarConfig(juno: SigningCosmWasmClient, registrar: string): Promise<void> {
...
export async function testQueryRegistrarVaultList(juno: SigningCosmWasmClient, registrar: string): Promise<void> {
