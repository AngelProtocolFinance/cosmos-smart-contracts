...
export async function testQueryMultisigConfig(juno: SigningCosmWasmClient, cw3: string): Promise<void> {
...
export async function testQueryProposalList(juno: SigningCosmWasmClient, cw3: string): Promise<void> {
...
export async function testQueryMultisigGroupWeight(juno: SigningCosmWasmClient, multisig_group: string): Promise<void> {
...
export async function testQueryMultisigVoters(juno: SigningCosmWasmClient, multisig: string): Promise<void> {
...
export async function testQueryListProposals(juno: SigningCosmWasmClient, multisig: string): Promise<void> {
...
export async function testQueryMultisigThreshold(juno: SigningCosmWasmClient, multisig: string): Promise<void> {
...
export async function testQueryGroupMembersList(juno: SigningCosmWasmClient, multisig: string): Promise<void> {
