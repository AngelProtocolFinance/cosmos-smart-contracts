...
async function initialize() {
    ...
    apTeam2 = await DirectSecp256k1HdWallet.fromMnemonic(config.mnemonicKeys.apTeam2, {
        prefix: config.networkInfo.walletPrefix,
    });
    apTeam3 = await DirectSecp256k1HdWallet.fromMnemonic(config.mnemonicKeys.apTeam3, {
        prefix: config.networkInfo.walletPrefix,
    });
    apTreasury = await DirectSecp256k1HdWallet.fromMnemonic(config.mnemonicKeys.apTreasury, {
        prefix: config.networkInfo.walletPrefix,
    });
    charity1 = await DirectSecp256k1HdWallet.fromMnemonic(config.mnemonicKeys.charity1, {
        prefix: config.networkInfo.walletPrefix,
    });
    charity2 = await DirectSecp256k1HdWallet.fromMnemonic(config.mnemonicKeys.charity2, {
        prefix: config.networkInfo.walletPrefix,
    });
    charity3 = await DirectSecp256k1HdWallet.fromMnemonic(config.mnemonicKeys.charity3, {
        prefix: config.networkInfo.walletPrefix,
    });
    ...
    console.log(`Using ${chalk.cyan(loopswapLoopJunoPairContract)} as loopSwap LOOP/JUNO Swap Pair`);
    console.log(`Using ${chalk.cyan(loopswapLoopJunoPairLpToken)} as loopSwap LOOP/JUNO Swap Pair LP Token`);
    console.log(`Using ${chalk.cyan(loopswapInitialLoopSupply)} as loopSwap Loop Initial Supply`);
    console.log(`Using ${chalk.cyan(loopswapLoopLiquidity)} as loopSwap LOOP/JUNO Pair LOOP liquidity`);
    console.log(`Using ${chalk.cyan(loopswapJunoLiquidity)} as loopSwap LOOP/JUNO Pair JUNO liquidity`);

    console.log(`Using ${chalk.cyan(loopswapMaloTokenContract)} as loopSwap MALO Token`);
    console.log(`Using ${chalk.cyan(loopswapMaloJunoPairContract)} as loopSwap MALO/JUNO Swap Pair`);
    console.log(`Using ${chalk.cyan(loopswapMaloJunoPairLpToken)} as loopSwap MALO/JUNO Swap Pair LP Token`);
    console.log(`Using ${chalk.cyan(loopswapInitialMaloSupply)} as loopSwap MALO Initial Supply`);
    console.log(`Using ${chalk.cyan(loopswapMaloJunoPairMaloLiquidity)} as loopSwap MALO/JUNO Pair MALO liquidity`);
    console.log(`Using ${chalk.cyan(loopswapMaloJunoPairJunoLiquidity)} as loopSwap MALO/JUNO Pair JUNO liquidity`);

    console.log(`Using ${chalk.cyan(loopswapKaloTokenContract)} as loopSwap KALO Token`);
    console.log(`Using ${chalk.cyan(loopswapKaloJunoPairContract)} as loopSwap KALO/JUNO Swap Pair`);
    console.log(`Using ${chalk.cyan(loopswapKaloJunoPairLpToken)} as loopSwap KALO/JUNO Swap Pair LP Token`);
    console.log(`Using ${chalk.cyan(loopswapInitialKaloSupply)} as loopSwap KALO Initial Supply`);
    console.log(`Using ${chalk.cyan(loopswapKaloJunoPairKaloLiquidity)} as loopSwap KALO/JUNO Pair KALO liquidity`);
    console.log(`Using ${chalk.cyan(loopswapKaloJunoPairJunoLiquidity)} as loopSwap KALO/JUNO Pair JUNO liquidity`);

    console.log(`Using ${chalk.cyan(loopswapMaloKaloPairContract)} as loopSwap MALO/KALO Swap Pair`);
    console.log(`Using ${chalk.cyan(loopswapMaloKaloPairLpToken)} as loopSwap MALO/KALO Swap Pair LP Token`);
    console.log(`Using ${chalk.cyan(loopswapMaloKaloPairMaloLiquidity)} as loopSwap KALO/JUNO Pair MALO liquidity`);
    console.log(`Using ${chalk.cyan(loopswapMaloKaloPairKaloLiquidity)} as loopSwap KALO/JUNO Pair KALO liquidity`);
