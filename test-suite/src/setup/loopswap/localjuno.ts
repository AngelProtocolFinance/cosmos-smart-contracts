...
export async function setupLoopSwap(
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")}=${factoryCodeId}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")}=${farmingCodeId}`
  );
  ...
  const loopTokenResult = await instantiateContract(
    juno,
    apTeam,
    apTeam,
    tokenCodeId,
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${loopTokenContract}`
  );

  // LOOP/JUNO pair contract
  process.stdout.write("Creating LOOP/JUNO pair contract ");
  const loopJunoPairResult = await sendTransaction(
    juno,
    apTeam,
    factoryContract,
    {
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${loopJunoPairContract}`
  );
  ...
  const maloTokenResult = await instantiateContract(
    juno,
    apTeam,
    apTeam,
    tokenCodeId,
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${maloTokenContract}`
  );

  // MALO/JUNO contract
  process.stdout.write("Creating MALO/JUNO pair contract ");
  const maloJunoPairResult = await sendTransaction(
    juno,
    apTeam,
    factoryContract,
    {
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${maloJunoPairContract}`
  );
  ...
  const kaloTokenResult = await instantiateContract(
    juno,
    apTeam,
    apTeam,
    tokenCodeId,
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${kaloTokenContract}`
  );

  // KALO/JUNO contract
  process.stdout.write("Creating KALO/JUNO pair contract ");
  const kaloJunoPairResult = await sendTransaction(
    juno,
    apTeam,
    factoryContract,
    {
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${kaloJunoPairContract}`
  );
  ...
  const maloKaloPairResult = await sendTransaction(
    juno,
    apTeam,
    factoryContract,
    {
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${maloKaloPairContract}`
  );
  ...
  const flpTokenResult1 = await instantiateContract(
    juno,
    apTeam,
    apTeam,
    tokenCodeId,
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${flpTokenContract2}`
  );

  process.stdout.write("Instantiating the Loopswap Farming contract");
  const farmingResult = await instantiateContract(
    juno,
    apTeam,
    apTeam,
    farmingCodeId,
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${farmingContract}`
  );
