...
import {
  ...
  sendTransaction,
  toEncodedBinary,
} from "../../utils/helpers/terra";
import { wasm_path } from "../../utils/config/wasmPaths";
import { localterra } from "../../utils/config/localterraConstants";
...
async function setup(
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")} = ${stablePairCodeId}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")} = ${routerCodeId}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")} = ${generatorCodeId}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")} = ${whitelistCodeId}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("codeId")} = ${vestingCodeId}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${astro}\n`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${astroportFactory}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${astroportGenerator}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${astroportRouter}\n`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${usdcUsdtPair}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${usdcUsdtPairLpToken}\n`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${lunaAstroPair}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${lunaAstroPairLpToken}\n`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${lunaUsdcPair}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${lunaUsdcPairLpToken}\n`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${lunaUsdtPair}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${lunaUsdtPairLpToken}\n`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${astroUsdcPair}`
  );
  ...
  console.log(
    chalk.green(" Done!"),
    `${chalk.blue("contractAddress")}=${astroUsdcPairLpToken}\n`
  );
