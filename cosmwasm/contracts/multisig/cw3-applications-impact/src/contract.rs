...
pub fn execute_propose_application(
    ...
    // Only Impact Endowments are processed through this CW3
    if msg.endow_type != EndowmentType::Impact {
        return Err(ContractError::Unauthorized {});
    }
    ...
    // ensure certain params are set correctly (regardless of what user passes)
